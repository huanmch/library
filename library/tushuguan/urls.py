...
urlpatterns = patterns('',
    ...
    url(r'^entry/$', 'tushuguan.views.index_page', name='home'),
    url(r'^ajax_index_/$', 'tushuguan.views.ajax_index_page', name='ajax_index_page'),
    url(r'^nav/$', 'tushuguan.views.nav_page', name='nav'),
    url(r'^borrow/$','tushuguan.views.borrow_page', name='borrow_page'),
    url(r'^register/$', 'tushuguan.views.register_page', name='register'),
    url(r'^ajax_register_/$', 'tushuguan.views.ajax_register_page', name='ajax_register_page'),
